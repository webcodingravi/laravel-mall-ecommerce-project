                ...
                <ol class="breadcrumb">
                    ...
                    @if (!empty($getSubCategory))
                        <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('ShowProduct', $getCategory->slug) }}">{{ $getCategory->name }}</a></li>
                                                ...
                                                @foreach ($getSubCategoryFilter as $SubCategory)
                                                    <div class="filter-item">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox"
                                                                {{ Request::get('category_id') ? 'checked' : '' }}
                                                                name="category_id" value="{{ $SubCategory->id }}"
                                    ...
                                    <div class="widget-body">
                                        <div class="filter-colors">
                                            @foreach ($getColor as $color)
                                                <a href="javascript:;" id="{{ $color->id }}" data-val="0"
                                                    class="ChangeColor" style="background: {{ $color->code }};">
