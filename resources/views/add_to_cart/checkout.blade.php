                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="first_name"
                                            value="{{ old('first_name', !empty(Auth::user()->name) ? Auth::user()->name : '') }}"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="last_name"
                                            value="{{ old('last_name', !empty(Auth::user()->last_name) ? Auth::user()->last_name : '') }}"
                                            id="last_name" class="form-control" placeholder="Please Enter Your Last Name..">
                                        <p></p>
                                    </div>
                                </div>
                                ...
                                <input type="text" name="company_name"
                                    value="{{ old('company_name', !empty(Auth::user()->company_name) ? Auth::user()->company_name : '') }}"
                                    class="form-control" placeholder="Please Enter Your Company Name..">

                                <label>Country <span class="text-danger">*</span></label>
                                <input type="text"
                                    value="{{ old('country', !empty(Auth::user()->country) ? Auth::user()->country : '') }}"
                                ...
                                <input type="text" name="address_one"
                                    value="{{ old('address_one', !empty(Auth::user()->address_one) ? Auth::user()->address_one : '') }}"
                                    class="form-control" placeholder="House number and Street name">
                                <input type="text" name="address_two"
                                    value="{{ old('address_two', !empty(Auth::user()->address_two) ? Auth::user()->address_two : '') }}"
                                    class="form-control" placeholder="Appartments, suite, unit etc ...">

                                <div class="row">
                                    <div class="col-sm-6">
                                        <label>City <span class="text-danger">*</span></label>
                                        <input type="text"
                                            value="{{ old('city', !empty(Auth::user()->city) ? Auth::user()->city : '') }}"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="state" id="state"
                                            value="{{ old('state', !empty(Auth::user()->city) ? Auth::user()->city : '') }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="postcode" id="postcode"
                                            value="{{ old('postcode', !empty(Auth::user()->postcode) ? Auth::user()->postcode : '') }}"
                                            class="form-control" placeholder="Please Enter Your Postcode / Zip..">
                                        <p></p>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="phone" id="phone"
                                            value="{{ old('phone', !empty(Auth::user()->phone) ? Auth::user()->phone : '') }}"
                                ...
                                @if (empty(Auth::check()))
                                    ...
                                    <div id="ShowPassword" style="display: none">
                                        ...
                                        <input type="password" id="inputPassword" name="password" class="form-control "
                                            placeholder="Please Enter Paasowrd..">
                                    </div>
                                @endif
                                            ...
                                            <td colspan="2">
                                                <div class="mt-1 cart-discount">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="">
                                                            <button id="ApplyDiscount" class="btn btn-outline-primary-2"
                                                                type="submit"><i
                                                ...
                                                <td>
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" value={{ $shipping->id }}
                                                            id="free-shipping{{ $shipping->id }}" required
                                                            name="shipping_id"
                    ...
                    if (data.status == false) {
                        ...
                        if (data.errors['first_name']) {
                            $("#first_name").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.errors['first_name']);
                        } else {
                        ...
                        if (data.errors['last_name']) {
                            $("#last_name").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.errors['last_name']);
                        } else {
                        ...
                        if (data.errors['country']) {
                            $("#country").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.errors['country']);
                        } else {
                        ...
                        if (data.errors['state']) {
                            $("#state").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.errors['state']);
                        } else {
                        ...
                        if (data.errors['postcode']) {
                            $("#postcode").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.errors['postcode']);
                        } else {
                            $("#postcode").removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        ...
                        if (data.errors['phone']) {
                            $("#phone").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.errors['phone']);
                        } else {
                        ...
                        if (data.errors['email']) {
                            $("#email_address").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.errors['email']);
                        } else {
                            $("#email_address").removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
