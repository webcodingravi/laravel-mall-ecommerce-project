                    ...
                    @if (!empty(Cart::content()->count()))
                        <div class="row">
                            <div class="col-lg-9">
                                <form action="{{ route('CartUpdate') }}" method="post">
                                            ...
                                            @foreach (Cart::content() as $key => $item)
                                                ...
                                                <tr>
                                                    <td class="product-col">
                                                        <div class="product">
                                                            ...
                                                            <h3 class="product-title">
                                                                ...
                                                                @if (!empty($size_id))
                                                                    <div>
                                                                        <strong>Size:</strong> {{ getSize($size_id)->size }}
                                                                        (${{ number_format(getSize($size_id)->price, 2) }})
                                                                    </div>
                                                                @endif
                                                    ...
                                                    <td class="quantity-col">
                                                        ...
                                                        <input type="hidden" name="cart[{{ $key }}][rowId]]"
                                                            class="form-control" value="{{ $item->rowId }}">
                                                    ...
                                                    <td class="remove-col"><a
                                                            href="{{ route('CartDelete', $item->rowId) }}"
                                    ...
                                    <div class="cart-bottom">
                                        <button class="btn btn-outline-dark-2"><span>UPDATE CART</span><i
                            ...
                            <aside class="col-lg-3">
                                ...
                                <a href="{{ route('home') }}" class="mb-3 btn btn-outline-dark-2 btn-block"><span>CONTINUE
