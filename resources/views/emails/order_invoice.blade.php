@component('mail::message')
    <div class="email-container">
        ...
        <p>Thank you for your recent purchase with <strong> {{ getSystemSetting()->website_name }}</strong>. We are Pleased
            ...
            <table>
                ...
                <tr>
                    @foreach ($order->getItem as $item)
                        ...
                        <td style="padding: 8px; border-bottom:1px solid #ddd;">${{ number_format($order->total_amount, 2) }}
                        </td>
                    @endforeach
                </tr>
        ...
        <p>Thank you for choosing <strong>{{ getSystemSetting()->website_name }}</strong>. We apperciate your business.</p>
    </div>
    Thanks,<br>
    {{ getSystemSetting()->website_name }}
@endcomponent
