...
<head>
    ...
    <title>{{ !empty($meta_title) ? $meta_title : '' }} - {{ getSystemSetting()->website_name }}</title>
                            ...
                            <div class="tab-content" id="tab-content-5">
                                <div class="tab-pane fade show active" id="signin" role="tabpanel"
                                    ...
                                    <form action="#" id="SubmitFormLogin" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="s_email">Email address <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="s_email" name="email"
                                        ...
                                        <div class="form-footer">
                                            ...
                                            <a href="{{ route('forgotPassword') }}" class="forgot-link">Forgot Your
                                                Password?</a>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel"
                                    ...
                                    <form id="SubmitFormRegister" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="s_email">Your email address <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="s_password">Password <span
                                                    class="text-danger">*</span></label>
                    ...
                    if (data.status == true) {
                        ...
                        if (data.error['email']) {
                            $("#s_email").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.error['email']);
                        } else {
                            $("#s_email").removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
                        ...
                        if (data.error['password']) {
                            $("#s_password").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.error['password']);
                        } else {
                            $("#s_password").removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
                        }
                    ...
                    if (data.status == true) {
                        ...
                        if (data.error['confirm_password']) {
                            $("#confirm_password").addClass('is-invalid').siblings('p').addClass(
                                'invalid-feedback').html(data.error['confirm_password']);
                        } else {
                            $("#confirm_password").removeClass('is-invalid').siblings('p').removeClass(
                                'invalid-feedback').html('');
