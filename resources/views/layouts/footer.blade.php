                    ...
                    <div class="widget widget-about">
                        ...
                        <div class="social-icons">
                            @if (!empty(getSystemSetting()->facebook_link))
                                <a href="{{ getSystemSetting()->facebook_link }}" class="social-icon" title="Facebook"
                                    target="_blank"><i class="icon-facebook-f"></i></a>
                            @endif
                            @if (!empty(getSystemSetting()->twitter_link))
                                <a href="{{ getSystemSetting()->twitter_link }}" class="social-icon" title="Twitter"
                                    target="_blank"><i class="icon-twitter"></i></a>
                            @endif
                            @if (getSystemSetting()->instagram_link)
                                <a href="{{ getSystemSetting()->instagram_link }}" class="social-icon" title="Instagram"
                                    target="_blank"><i class="icon-instagram"></i></a>
                            @endif

                            @if (!empty(getSystemSetting()->youtube_link))
                                <a href="{{ getSystemSetting()->youtube_link }}" class="social-icon" title="Youtube"
                                    target="_blank"><i class="icon-youtube"></i></a>
                            @endif

                            @if (!empty(getSystemSetting()->pinterest_link))
                                <a href="{{ getSystemSetting()->pinterest_link }}" class="social-icon" title="Pinterest"
        ...
        <div class="container">
            ...
            @if (!empty(getSystemSetting()->payment_icon))
                <figure class="footer-payments">
                    <img src="{{ asset('uploads/setting/payment-icon/' . getSystemSetting()->payment_icon) }}"
