        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="card-title"><a class="btn btn-primary btn-sm"  href="{{route('discount.list')}}" style="background: #cc9966; border:none"><i class="bi bi-arrow-clockwise"></i> Reset</a></h5>
              <a class="btn btn-primary btn-sm" href="{{route('discount.create')}}" style="background: #cc9966; border:none">+ Add Discount Code</a>
            </div>
              ...
              <table class="table table-striped table-bordered">
                ...
                @foreach ($discountCodes as $discount)
                  <tr>
                    ...
                    <td>
                        <a href="{{route('discount.edit',$discount->id)}}" class="btn btn-primary btn-sm" style="background: #cc9966; border:none"><i class="bi bi-pencil-square"></i> Edit</a>
