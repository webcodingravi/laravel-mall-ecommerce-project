...
<main id="main" class="main" style="height: 100vh">
    <div class="pagetitle d-flex justify-content-between">
      <h1>Category List (Total: {{$categories->total()}})</h1>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="card-title">Category List <a class="btn btn-primary btn-sm"  href="{{route('category.list')}}"><i class="bi bi-arrow-clockwise"></i> Reset</a></h5>
              ...
              <table class="table table-striped table-bordered">
                ...
                @foreach ($categories as $category)
                  <tr>
                    ...
                    <td><a href="{{route('category.edit',$category->id)}}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>
