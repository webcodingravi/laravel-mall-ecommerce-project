                        ...
                        <div class="card-body">
                            <form class="row g-3" action="{{ route('category.store') }}" method="post">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" value="{{ old('button_name') }}" name="button_name"
                                        class="form-control" placeholder="Please Enter Button Name...">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" name="is_menu" class="form-check-input">
                                </div>
