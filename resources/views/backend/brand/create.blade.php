...
<main id="main" class="main" style="height: 100vh">
    <div class="pagetitle d-flex justify-content-between">
      <h1 style="color: #cc9966;">Create Brand</h1>
            ...
            <div class="card-body">
              <form class="row g-3" action="{{route('brand.store')}}" method="post">
                ...
                <div class="col-6">
                  ...
                  <input type="text" name="name" value="{{old('name')}}" id="name" placeholder="Please Enter Brand Name..." class="form-control @error('name') is-invalid @enderror">
                  @error('name')
