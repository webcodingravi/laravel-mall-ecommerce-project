...
<main id="main" class="main" style="height: 100vh">
    <div class="pagetitle d-flex justify-content-between">
      <h1 style="color: #cc9966;">Brand List (Total: {{$brands->total()}})</h1>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="card-title"><a class="btn btn-primary btn-sm"  href="{{route('brand.list')}}" style="background: #cc9966; border:none"><i class="bi bi-arrow-clockwise"></i> Reset</a></h5>
              <a class="btn btn-primary btn-sm" href="{{route('brand.create')}}" style="background: #cc9966; border:none">+ Add Brand</a>
            </div>
              ...
              <table class="table table-striped table-bordered">
                ...
                @foreach ($brands as $brand)
                  <tr>
                    ...
                    <td><a href="{{route('brand.edit',$brand->id)}}" class="btn btn-primary btn-sm" style="background: #cc9966; border:none"><i class="bi bi-pencil-square"></i> Edit</a>
