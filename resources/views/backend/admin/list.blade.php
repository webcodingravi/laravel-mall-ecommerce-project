...
<main id="main" class="main" style="height: 100vh">
    <div class="pagetitle d-flex justify-content-between">
      <h1>Admin List (Total: {{$getAdmins->total()}})</h1>
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="d-flex align-items-center justify-content-between">
              <h5 class="card-title">Admin List <a class="btn btn-primary btn-sm"  href="{{route('admin.list')}}"><i class="bi bi-arrow-clockwise"></i> Reset</a></h5>
              <a class="btn btn-primary btn-sm" href="{{route('admin.create')}}">+ Add Admin</a>
            </div>
                ...
                @foreach ($getAdmins as $admin)
                  <tr>
                   ...
                   <img src="{{asset('uploads/profile_pic/'.$admin->image)}}" class="img-fluid" style="width: 100px; height:100px; object-fit:cover; border-radius:50%;">
                    ...
                    <td><a href="{{route('admin.edit',$admin->id)}}" class="btn btn-primary btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>
