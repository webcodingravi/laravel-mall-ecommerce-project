...
@section('content')
    <main class="main">
        ...
        <div class="container">
            <div class="text-center page-header page-header-big"
                style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 1) 100%), url({{ asset('uploads/pages/' . $contact->image) }})">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <form action="{{ route('SubmitContact') }}" class="mb-3 contact-form" autocomplete="off"
                            method="post">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                            ...
                            <textarea class="form-control @error('message') is-invalid @enderror" cols="30" rows="4" name="message"
                                id="cmessage" placeholder="Message *">{{ old('message') }}</textarea>
                            @error('message')
                                <span class="invalid-feedback" style="margin-top:-20px;">{{ $message }}</span>
                            @enderror
