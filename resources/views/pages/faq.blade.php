...
@section('content')
    <main class="main">
                        ...
                        @foreach ($getFaq as $faq)
                            <div class="card card-box card-sm bg-light">
                                <div class="card-header" id="heading-1">
                                    <h2 class="card-title">
                                        <a role="button" data-toggle="collapse" href="#collapse-{{ $faq->id }}"
                                ...
                                <div id="collapse-{{ $faq->id }}" class="collapse " aria-labelledby="heading-1"
        ...
        <div class="pt-4 pb-4 cta cta-display bg-image"
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-9 col-xl-7">
                        <div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
                            ...
                            <div class="col-auto">
                                <a href="{{ route('contact') }}" class="btn btn-outline-white"><span>CONTACT US</span><i
