...
<main class="main">
    ...
    <div class="container">
        <div class="text-center page-header page-header-big" style="background-image: url({{asset('uploads/pages/'.$PrivacyPolicy->image)}})">
            <h1 class="text-white page-title">{{$PrivacyPolicy->title}}</h1>
        </div>
    </div>
